<<<<<<< HEAD:ProjectShowOffUnityProject/Assets/9. Editor/ObstaclesSpawnEditor.cs
    ...
    public class ObstaclesSpawnEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_obstacles.ControlledSpawn)
            {
                ...
                {
                    _obstacles.Area1Object = (GameObject)EditorGUILayout.ObjectField("Obstacle",_obstacles.Area1Object, typeof(GameObject), true);
                }
                ...
                {
                    _obstacles.Area2Object = (GameObject)EditorGUILayout.ObjectField("Obstacle",_obstacles.Area2Object, typeof(GameObject), true);
                }
                ...
                {
                    _obstacles.Area3Object = (GameObject)EditorGUILayout.ObjectField("Obstacle",_obstacles.Area3Object, typeof(GameObject), true);
                }
                EditorGUI.indentLevel--;
            }
            else
...
>>>>>>> obstaclesOnThePath:ProjectShowOffUnityProject/Assets/Editor/ObstaclesSpawnEditor.cs
}