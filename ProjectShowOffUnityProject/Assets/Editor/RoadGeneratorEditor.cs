...
public class RoadGeneratorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_showHiddenFields)
        {
            ...
            _generator.NormalRoadBorderSpace = EditorGUILayout.IntField(_generator.NormalRoadBorderSpace, GUILayout.ExpandWidth(false));
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Space from the border (C)");
            EditorGUILayout.Space();
            _generator.CrossRoadBorderSpace = EditorGUILayout.IntField(_generator.CrossRoadBorderSpace, GUILayout.ExpandWidth(false));
            EditorGUILayout.EndHorizontal();
